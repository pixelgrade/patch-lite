...
class PatchLite_PixelgradeCare_DownloadNotice {

	protected $download_url;

	/**
	 * The only instance.
	 * @var     PatchLite_PixelgradeCare_DownloadNotice
	 * @access  protected
	 */
	...
	/**
	 * Main PatchLite_PixelgradeCare_DownloadNotice Instance
	 *
	 * Ensures only one instance of PatchLite_PixelgradeCare_DownloadNotice is loaded or can be loaded.
	 *
	 * @static
	 *
	 * @return PatchLite_PixelgradeCare_DownloadNotice Main PatchLite_PixelgradeCare_DownloadNotice instance
	 */
