...
?>
	...
	<footer id="colophon" class="site-footer" role="contentinfo">
		...
		wp_nav_menu( array(
			...
			'items_wrap'         => '<nav class="footer-menu"><h5 class="screen-reader-text">'.__( 'Footer navigation', 'patch-lite' ).'</h5><ul id="%1$s" class="%2$s">%3$s</ul></nav>',
			'depth'          => 1,
			'fallback_cb'    => '',
		) ); ?>
	</footer><!-- #colophon -->
	<div class="overlay--search">
		<div class="overlay__wrapper">
			<?php get_search_form(); ?>
			<p><?php _e( 'Begin typing your search above and press return to search. Press Esc to cancel.', 'patch-lite' ); ?></p>
		</div>
